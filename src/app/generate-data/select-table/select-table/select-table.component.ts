...
export class SelectTableComponent implements OnInit {
  ...
  tables: TableDetails;
  displayedColumns: string[] = ['table_name', 'column_number', 'record_number', 'created_date','update_date'];
  ...
  ngOnInit() {
    this.store.dispatch(new tableActions.LoadTableDetails());
    this.store.select(fromStore.getTables).subscribe((data)=>{
